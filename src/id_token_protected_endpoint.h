...
public:
  ...
  bool set_refresh_token(const std::experimental::string_view _refresh_token);
  ...
  virtual std::experimental::string_view get_id_token();
  virtual bool set_id_token(const std::experimental::string_view id_token);
